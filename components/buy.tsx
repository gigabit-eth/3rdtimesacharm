        ...
        <div className="py-12 md:py-14">
          ...
          <div className="max-w-3xl mx-auto text-center pb-8 md:pb-10">
            <h2 className="h2 mb-4 uppercase">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#ffc824] to-[#e30f0f]">
                How to Buy
              </span>{" "}
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-zinc-800 rounded shadow-xl">
              ...
              <p className="text-gray-400 text-center w-full font-mono break-all">
            ...
            <div className="relative flex flex-col items-center p-6 bg-zinc-800 rounded shadow-xl">
              ...
              <p className="text-gray-400 text-center">
                Enjoy the <strong>$GME</strong>Coin ride to the moon! we early!
              </p>
            </div>
          </div>
        </div>
