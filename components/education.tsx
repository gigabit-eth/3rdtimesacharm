        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-zinc-800 rounded shadow-xl">
              ...
              <a
                href="https://www.youtube.com/watch?v=V7pcZ3-vYeM"
                target="_blank"
              >
              ...
              <p className="text-gray-600 text-center">
                Easy How-To guide from an OG in the space!
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-zinc-800 rounded shadow-xl">
              ...
              <a
                href="https://www.youtube.com/watch?v=GAS-AfBDlIw"
                target="_blank"
              >
                <h4 className="text-lg font-bold leading-snug tracking-tight mb-1 text-gray-200">
                  Buy $GME w/ Phantom Wallet
                </h4>
              </a>
              <p className="text-gray-600 text-center">
                Another great community member How-To buy video!
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-zinc-800 rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center text-sm">
                Basic wallet security, scammer/hacker attacks, handle spam coins
                & nfts
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-zinc-800 rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Will you create the next great $GME tutorial?
              </p>
            </div>
          </div>
        </div>
